...
/**
  ...
  */
  ...
  #define HSE_VALUE    (8000000U) /*!< Value of the MCU HSE oscillator in Hz */
#endif /* HSE_VALUE */
...
#define ETH_MAC_ADDR1    ((uint8_t)0x51)
#define ETH_MAC_ADDR2    ((uint8_t)0x4D)
#define ETH_MAC_ADDR3    ((uint8_t)0x55)
#define ETH_MAC_ADDR4    ((uint8_t)0x57)
